...
\shorterSection{\textbf{Experience}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{}
          {Working in AT\&T Labs to develop a python application for sending virtual network function data to an Apache Pulsar message bus where data is consumed and analyzed by Apache Flink}
        \resumeItem{}
          {Scrum master and full stack developer among a team of interns building a MERN stack (Mongo, Express, React, Node) application for improving student engagement in online classroom environments}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Data Visualization Researcher}{Aug 2020 - Present}
        ...
        \resumeItem{}
          {Designing and building visual analytical tools of Notre Dame student learning data with the goal of helping close academic performance gaps resulting from disparities in student backgrounds}
      \resumeItemListEnd
