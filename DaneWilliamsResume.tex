...
\vspace{0pt}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{}
        {Cumulative GPA: 3.74/4.0, Major GPA: 3.86/4.0, Dean's List (Spring 2020, Fall 2020)}
      \resumeItem{}
...
\shorterSection{\textbf{Skills}}
  ...
  \small
    \item[]{\hspace{-12pt}
     \textbf{Languages}{: Python, C, Shell, C++, JavaScript, Java, Verilog, HTML/CSS, ARM Assembly}
     \hfill
